...
// It is intentionally simple; rendering is written to Out to keep it testable.
type Runner struct {
...
func (r Runner) Run(ctx context.Context, opts clieval.Options) error {
	out := r.Out
	if out == nil {
		out = os.Stdout
	}
