...
type Runner struct { Svc *svc.Service }
...
func (r *Runner) Run(ctx context.Context, opts cli.Options) (mlclient.PredictResponse, error) {
	if r == nil { return mlclient.PredictResponse{}, errors.New("nil runner") }
	if r.Svc == nil { return mlclient.PredictResponse{}, errors.New("missing service") }
