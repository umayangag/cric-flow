...
type FeatureProvider interface {
    ...
    GetPlayerFeaturesAtCutoff(ctx context.Context, cutoff time.Time, playerIDs []int64) (map[int64]map[string]float64, error)
}
...
func (p *DefaultFeatureProvider) GetPlayerFeaturesAtCutoff(ctx context.Context, cutoff time.Time, playerIDs []int64) (map[int64]map[string]float64, error) {
