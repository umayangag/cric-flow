...
func EnsureMatchWithFormat(ctx context.Context, matchID int64, formatID int64, matchDate string, originalMatchType string) error {
	if Pool == nil {
		return errors.New("db pool not initialized")
	}
	_, err := Pool.Exec(ctx, `INSERT INTO match_details(match_id, format_id, match_date, original_match_type) VALUES($1, $2, $3, $4)
		ON CONFLICT (match_id) DO NOTHING`, matchID, formatID, matchDate, originalMatchType)
	return err
}
