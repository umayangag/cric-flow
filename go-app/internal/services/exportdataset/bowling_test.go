...
func TestBowlingService_Exports(t *testing.T) {
    ...
    cases := []struct {
        ...
        {"unified writes rows", func(ctx context.Context, s *svc.BowlingService, w *bytes.Buffer, m *dbmocks.MockDatasetRepo) error {
        ...
        {"inference writes rows", func(ctx context.Context, s *svc.BowlingService, w *bytes.Buffer, m *dbmocks.MockDatasetRepo) error {
            m.EXPECT().BowlingInferenceRows(mock.Anything, "T20I").Return([][]string{{"ih1", "ih2"}, {"5", "6"}}, nil)
...
func TestBowlingService_Errors(t *testing.T) {
    ...
    cases := []struct {
        ...
        {"unified error", func(ctx context.Context, s *svc.BowlingService, w *bytes.Buffer, m *dbmocks.MockDatasetRepo) error {
        ...
        {"inference error", func(ctx context.Context, s *svc.BowlingService, w *bytes.Buffer, m *dbmocks.MockDatasetRepo) error {
