When the user says "/run-check-all-incremental" or when fixing lint, format, or test failures and you want all checks to pass without rerunning the full check-all repeatedly
