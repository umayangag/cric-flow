---
name: run-github-workflows-local
description: Runs all runnable GitHub Actions workflows locally using equivalent make/npm commands. Use when verifying CI before push, debugging workflow failures, or ensuring local changes pass the same checks as GitHub Actions.
---
