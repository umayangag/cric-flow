...
const MatchCompareDbTab: React.FC = () => {
  ...
  const onCompare = async () => {
    ...
    try {
      ...
      const actualWinnerIndex =
        data.squads[0].actual_win === 1 ? 0 : data.squads[1].actual_win === 1 ? 1 : null;
  ...
  return (
    <div>
      <p style={{ marginTop: 0 }}>
        Compare ML prediction vs actual result for a specific match from DB squads. Enter a match
        ID, select an as-of date and optional format, then click Compare.
      </p>
