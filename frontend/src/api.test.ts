...
describe('frontend api client (DB-backed)', () => {
  ...
  it('getMatchSquads returns squads payload', async () => {
    mockFetchOnce({
      ...
      teams: ['Team A', 'Team B'],
      squads: [
        { team_name: 'Team A', actual_win: 1, players: [{ player_name: 'A1', runs_scored: 0, balls_faced: 0, fours_scored: 0, sixes_scored: 0, batting_position: 0, strike_rate: 0, runs_conceded: 0, deliveries: 0, wickets_taken: 0, econ: 0 }] },
        { team_name: 'Team B', actual_win: 0, players: [{ player_name: 'B1', runs_scored: 0, balls_faced: 0, fours_scored: 0, sixes_scored: 0, batting_position: 0, strike_rate: 0, runs_conceded: 0, deliveries: 0, wickets_taken: 0, econ: 0 }] },
      ],
    });
