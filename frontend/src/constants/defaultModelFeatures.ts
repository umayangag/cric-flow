...
export const DEFAULT_MODEL_FEATURES: ModelMetadataResponse = {
  ...
  win: {
    ...
    features: [
      ...
      'team1_bat_consistency_mean',
      'team1_bat_consistency_std',
      'team1_bat_consistency_max',
      'team1_bat_consistency_min',
      'team1_bat_consistency_top3_mean',
      'team1_bat_consistency_count',
      'team1_bowl_consistency_sum',
      'team1_bowl_consistency_mean',
      'team1_bowl_consistency_std',
      'team1_bowl_consistency_max',
      'team1_bowl_consistency_min',
      'team1_bowl_consistency_top3_mean',
      'team1_bowl_consistency_count',
      'team2_bat_consistency_sum',
      'team2_bat_consistency_mean',
      'team2_bat_consistency_std',
      'team2_bat_consistency_max',
      'team2_bat_consistency_min',
      'team2_bat_consistency_top3_mean',
      'team2_bat_consistency_count',
      'team2_bowl_consistency_sum',
      'team2_bowl_consistency_mean',
      'team2_bowl_consistency_std',
      'team2_bowl_consistency_max',
      'team2_bowl_consistency_min',
      ...
      'team1_bat_form_max',
      'team1_bat_form_min',
      'team1_bat_form_top3_mean',
      'team1_bat_form_count',
      'team1_bowl_form_sum',
      'team1_bowl_form_mean',
      'team1_bowl_form_std',
      'team1_bowl_form_max',
      'team1_bowl_form_min',
      'team1_bowl_form_top3_mean',
      'team1_bowl_form_count',
      'team2_bat_form_sum',
      'team2_bat_form_mean',
      'team2_bat_form_std',
      'team2_bat_form_max',
      ...
      'team2_bat_form_count',
      'team2_bowl_form_sum',
      'team2_bowl_form_mean',
      'team2_bowl_form_std',
      'team2_bowl_form_max',
      'team2_bowl_form_min',
      'team2_bowl_form_top3_mean',
      'team2_bowl_form_count',
