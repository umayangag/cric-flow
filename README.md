...
- **Docs:** **docs/README.md** (index), **docs/overview.md** (architecture, pipeline), **docs/config-and-data.md** (config, import, export), **docs/apis-backtest-and-ops.md** (APIs, backtest, ops), **docs/roadmap.md** (planned improvements).
