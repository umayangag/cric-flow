...
distinct clubs — and it came back **515 from Postgres against 386 from the archive**. The
...
Both sources now key a team by its club and its gender, and report 515.
