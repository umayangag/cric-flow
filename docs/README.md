...
| [WIN_PROB_SELECTION_PR_CHECKLIST.md](WIN_PROB_SELECTION_PR_CHECKLIST.md) | Select the XI that maximises win probability (**S-1…S-3c done. The leak is fixed and the honest held-out AUC is 0.56–0.63, so S-4 and S-6 are blocked on the new S-9: make the win model discriminate**) |
