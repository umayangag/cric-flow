...
| [OPS_CONSOLE_PR_CHECKLIST.md](OPS_CONSOLE_PR_CHECKLIST.md) | Run the whole pipeline from the frontend: acquisition, extraction, structured progress, chaining (**8 items open**) |
