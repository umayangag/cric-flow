...
| [WIN_PROB_SELECTION_PR_CHECKLIST.md](WIN_PROB_SELECTION_PR_CHECKLIST.md) | Select the XI that maximises win probability (**S-1…S-3c, S-9 done; S-10 in the tree behind `selection.win_model: "xi"`, awaiting its DB acceptance run; S-6 is the gate = P-0 of the re-architecture plan; S-5/S-5b cancelled, S-7/S-8 superseded by that plan**) |
