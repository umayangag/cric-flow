...
def get_match_data(match_id, session):
    ...
    inning, session, toss, venue_id, opposition_id, season_id, score, wickets, balls, target, extras, match_number, result = db_cursor.fetchall()[
        0]
    return inning, session, toss, venue_id, opposition_id, season_id, score, wickets, balls, target, extras, match_number, result
