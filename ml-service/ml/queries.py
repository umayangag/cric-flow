batting_dataset_query = (
    "SELECT  runs, batting_data.balls, batting_data.fours, batting_data.sixes, batting_position, "
...
batting_win_dataset_query = (
    "SELECT  match_details.score, match_details.balls, runs, batting_data.balls, batting_data.fours, batting_data.sixes, strike_rate, batting_data.match_id, batting_position,"
