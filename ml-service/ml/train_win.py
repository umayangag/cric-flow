...
def rows_to_xy_by_format(
    ...
    _numeric_set = (set(WIN_ENHANCED_FEATURE_COLS) | {WIN_TARGET_COL, "match_month_sin", "match_month_cos", "match_day_of_week_sin", "match_day_of_week_cos"}) - {
        "format_code",
        "match_date",
    }
    ...
    if "format_code" in df.columns:
        ...
        df["format_is_OTHER"] = (~fmt_series.isin(win_format_codes)).astype(float)
